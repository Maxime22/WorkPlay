...
import { loadInputs, saveInputs, addInput, deleteInput } from '../../utils/StorageUtils.ts';
...
describe('storageUtils', () => {
    ...
    it('loads inputs correctly', async () => {
        ...
        (AsyncStorage.getItem as jest.Mock).mockResolvedValue(JSON.stringify(['Task 1', 'Task 2']));
    ...
    it('saves inputs correctly', async () => {
        ...
        expect(AsyncStorage.setItem).toHaveBeenCalledWith('inputs', JSON.stringify(['Task 1', 'Task 2']));
    });
    ...
    it('deletes an input correctly', async () => {
        ...
        expect(AsyncStorage.setItem).toHaveBeenCalledWith('inputs', JSON.stringify(['Task 2']));
    });
});
